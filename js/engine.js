...
var Engine = (function(global) {
  ...
  var doc = global.document,
    ...
    highestScore = doc.querySelector('#highestScore'),
    lastTime;
  ...
  setHighestScore(getHighestScore() || 0);
  ...
  function setHighestScore(value) {
    highestScore.innerHTML = value;
    localStorage.setItem('score', value);
  }

  function getHighestScore() {
    return Number.parseInt(localStorage.getItem('score'));
  }
  ...
  global.getHighestScore = getHighestScore;
  global.setHighestScore = setHighestScore;
})(this);
